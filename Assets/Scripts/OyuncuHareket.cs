...
public class OyuncuHareket : MonoBehaviour
{
    ...
    void Update()
    {
        //Hangi ortamda oyunu çalýþtýrýyorsa o ortama göre fonksiyonlarý kullanýyor.
#if UNITY_EDITOR
        KlavyeKontrol();
#else
        JoystickKontrol();
    ...
    void KlavyeKontrol()
    {
        ...
        Vector2 scale = transform.localScale; //þu anki scale deðerini aldýk. buradaki amacýmýz karakter saða ve sola giderken baktýðý yönünün deðiþmesini saðlamak.
